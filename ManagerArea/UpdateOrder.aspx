<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateOrder.aspx.vb" Inherits="ManagerArea_UpdateOrder" %>
                  ...
                  <h2>Update Order</h2>
                    <p>&nbsp;</p>
                          ...
                          <p class="text-muted lead text-center">
                             NOTE: To check if payment has been successfull enter your OrderID into the Track your Order page. The options avaible are:
                            </br>
                            1.Nothing- Payment has not been checked by Manager (Please allow 24 hours)
                            </br>
                            2.Payment In Full - Full payment has been and out for delivery the same day.
                            </br>
                            3.No Full Payment - Only part of the payment has made, the manager will contact you the same day about this.
                    ...
                    <p>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UniConnString %>" DeleteCommand="DELETE FROM [Orders] WHERE [OrderID] = @OrderID" InsertCommand="INSERT INTO [Orders] ([First_Name], [Last_Name], [Address], [City], [County], [Postcode], [Number], [Date], [Order_Status]) VALUES (@First_Name, @Last_Name, @Address, @City, @County, @Postcode, @Number, @Date, @Order_Status)" SelectCommand="SELECT * FROM [Orders]" UpdateCommand="UPDATE [Orders] SET [First_Name] = @First_Name, [Last_Name] = @Last_Name, [Address] = @Address, [City] = @City, [County] = @County, [Postcode] = @Postcode, [Number] = @Number, [Date] = @Date, [Order_Status] = @Order_Status WHERE [OrderID] = @OrderID">
                            <DeleteParameters>
