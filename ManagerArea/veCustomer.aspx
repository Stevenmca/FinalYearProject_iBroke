<%@ Page Language="VB" AutoEventWireup="false" CodeFile="veCustomer.aspx.vb" Inherits="ManagerArea_veCustomer" %>
            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown active"><a href="../index.aspx">Home</a>
                  ...
                  <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">Customers <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="Customer.aspx" class="nav-link">Add New Customer</a></li>
                    <li class="dropdown-item"><a href="veCustomer.aspx" class="nav-link">Edit Customers</a></li>
                  </ul>
                </li>
                <li><a href="#">Repairs</a>
                ...
                <!-- ========== FULL WIDTH MEGAMENU ==================-->
                <li class="nav-item dropdown menu-large"><a href="#">Technican<b class="caret"></b></a>
                </li>
          ...
          <section class="bar pt-0">
            <div class="row">
              ...
              <div class="col-md-8 mx-auto" >
                  <asp:Button ID="Button1" runat="server" Text="Find Customer" class="btn btn-template-outlined" />
                  <br />
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="BookingID" DataSourceID="SqlDataSource2">
                      <Columns>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:UniConnString %>" SelectCommand="SELECT * FROM [Customer]"></asp:SqlDataSource>
                  <br />
                </div>
                ...
                <div class="heading text-center">
                 ...
                 <div class="col-md-8 mx-auto">
                 <asp:Button ID="btned" runat="server" Text="Click here to Edit/Delete Customer" class="btn btn-template-outlined" />
                     <br />
                     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="BookingID" DataSourceID="SqlDataSource1">
                         <Columns>
                     ...
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UniConnString %>" DeleteCommand="DELETE FROM [Customer] WHERE [BookingID] = @BookingID" InsertCommand="INSERT INTO [Customer] ([FirstName], [LastName], [ContactNum]) VALUES (@FirstName, @LastName, @ContactNum)" SelectCommand="SELECT * FROM [Customer]" UpdateCommand="UPDATE [Customer] SET [FirstName] = @FirstName, [LastName] = @LastName, [ContactNum] = @ContactNum WHERE [BookingID] = @BookingID">
                         <DeleteParameters>
