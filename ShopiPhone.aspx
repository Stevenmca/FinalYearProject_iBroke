<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShopiPhone.aspx.vb" Inherits="ShopiPhone" %>
        ...
        <div class="container">
          <div class="row bar">
            <div class="col-md-12">
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        ...
                        <p class="text-muted lead text-center">iPhoneX, 64GB, Jet Black, 3 months Apple Warranty</p>
                          <p class="price">Quantity</p>
                          <asp:TextBox ID="tbiphonex" runat="server" Width="30px"></asp:TextBox>
                          </br>
                          <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="tbiphonex" ValidationExpression="\d+" Display="Static" EnableClientScript="true" ErrorMessage="Numbers Only" ForeColor="#CC0000"></asp:RegularExpressionValidator>
                          </br>
                          <asp:Button ID="btnAddiphone1" runat="server" Text="Add to Cart" class="btn btn-template-outlined" OnClick="btnAddiphone1_Click" />
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      <div class="image"><a href="#"><img src="img/iphone8p.png" alt="" class="img-fluid image1">
                          </a></div>
                      <div class="text">
                        <h3 class="h5"><a href="#">iPhone 8 Plus</a></h3>
                        <p class="text-muted lead text-center">iPhone 8 Plus, 32GB, Rose Gold, 30 day warranty</p>
                      ...
                      <div class="ribbon-holder">
                        <div class="ribbon sale">£699</div>
                          ...
                          <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="tbiphone8p" ValidationExpression="\d+" Display="Static" ErrorMessage="Numbers Only" ForeColor="#CC0000"></asp:RegularExpressionValidator>
                          </br>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        ...
                        <p class="text-muted lead text-center">iPhone 8, 32GB, Gold , 3 months Apple Warranty</p>
                              <div class="ribbon-holder">
                        <div class="ribbon sale">£699</div>
                          <p class="price">Quantity</p>
                          <asp:TextBox ID="tbiphone8" runat="server" Width="30px"></asp:TextBox>
                            </br><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ValidationExpression="\d+" Display="Static" ErrorMessage="Numbers Only" ControlToValidate="tbiphone8" ForeColor="#CC0000"></asp:RegularExpressionValidator>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        ...
                        <p class="text-muted lead text-center">iPhone 7 Plus, 32GB, Jet Black, 30 day warranty</p>
                          <div class="ribbon-holder">
                        <div class="ribbon sale">£445</div>
                          <p class="price">Quantity</p>
                          <asp:TextBox ID="tbiphone7p" runat="server" Width="30px"></asp:TextBox>
                            </br>
                              <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ValidationExpression="\d+" Display="Static" ErrorMessage="Numbers Only" ControlToValidate="tbiphone7p" ForeColor="#CC0000"></asp:RegularExpressionValidator>
                          </br>
              ...
              <div class="row">
                <div class="col-md-12 banner mb-small text-center"><a href="#">
                    <asp:Button ID="btnCart" runat="server" Text="View Cart" class="btn btn-template-outlined" />
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 text-center-md">
                <p>&copy; 2018. Your company / name goes herecol-lg-4 text-center-md">
