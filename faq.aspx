                ...
                <div id="accordion" role="tablist">
                  <div class="card card-primary">
                    <div id="headingOne" role="tab" class="card-header">
                      <h5 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Why should i use iBroke for a repair?</a></h5>
                    </div>
                    <div id="collapseOne" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" class="collapse show">
                      <div class="card-body">
                        <p>Your smartphone is extremly important to us. iBroke technicans are fully qualifed and under go strict training to ensure all repairs go as planned. With over 10,000 repairs we are a trusted repair chain. We reapir all kinds of devices such as;</p>
                        <ul>
                          <li>Smartphones</li>
                          <li>Tablets</li>
                  ...
                  <div class="card card-primary">
                    <div id="headingTwo" role="tab" class="card-header">
                      <h5 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">How long does a repair take?</a></h5>
                    </div>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="contact_feedback.aspx" class="nav-link">Feedback page</a></li>
                    <li class="nav-item"><a href="contactus.aspx" class="nav-link">Contact page</a></li>
                    <li class="nav-item"><a href="faq.aspx" class="nav-link">FAQ</a></li>
                  </ul>
                </div>
              </div>
              <div class="banner"><a href="#"><img src="img/FAQ.png" class="img-fluid"></a></div>
            </div>
          </div>
        </div>
      </div>
