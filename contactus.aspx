            ...
            <div class="row text-center">
              <div class="col-md-4">
                <div class="box-simple">
                  ...
                  <p>120 Main Street<br>                                        Dungiven, BT47 4LG<br>                                        Derry,  <strong>N.Ireland</strong></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="box-simple">
                  ...
                  <p>This number is our shop number, so if you have any problems please do not hesitate to call us.</p>
                  <p><strong>+447835686188</strong></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="box-simple">
                  ...
                  <p>Please feel free to write an email to us to make an enquire or ask a question.</p>
                  <ul class="list-unstyled text-sm">
                    <li><strong><a href="mailto:">ibroke@hotmail.com</a></strong></li>
                  </ul>
                </div>
              </div>
            </div>
