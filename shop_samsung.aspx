        ...
        <div class="container">
          <div class="row bar">
            <div class="col-md-12">
              ...
              <p class="text-muted lead text-center">Our range of Samsung devices come fully sealed, unlocked to any worldwide network and have 3 months warranty.</p>
              <div class="products-big">
                <div class="row products">
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      <div class="image"><a href="shop-detail.html"><img src="img/s9.png" alt="" class="img-fluid image1"></a></div>
                      <div class="text">
                          <div class="ribbon new">NEW</div>
                        <h3 class="h5"><a href="#">Samsung S9</a></h3>
                        <p class="price">£889</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      <div class="image"><a href="#"><img src="img/s8.png" alt="" class="img-fluid image1"></a></div>
                      <div class="text">
                        <h3 class="h5"><a href="#">Samsung S8</a></h3>
                        <p class="price">
                          <del>£599</del> £450
                        </p>
                      </div>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      <div class="image"><a href="#"><img src="img/s7e.png" alt="" class="img-fluid image1"></a></div>
                      <div class="text">
                        <h3 class="h5"><a href="#">Samsung S7 edge</a></h3>
                        <p class="price">£349</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      <div class="image"><a href="#"><img src="img/s7.png" alt="" class="img-fluid image1"></a></div>
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">Samsung S7</a></h3>
                        <p class="price">£279</p>
                      </div>
                    </div>
                  </div>
