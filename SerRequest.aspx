<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SerRequest.aspx.vb" Inherits="SerRequest" %>
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Service Request</h1>
            </div>
            <div class="col-md-5">
            ...
            <div class="row">
              ...
              <div class="col-md-8 mx-auto">
                  ...
                  <div class="row">
                       <div class="col-sm-6">
                      <div class="form-group">
                        &nbsp;<asp:TextBox ID="tbRequestID" runat="server" class="form-control" Visible="False"></asp:TextBox>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="firstname">How did you hear about us?</label>
                            <asp:TextBox ID="tbCustFname" runat="server" class="form-control"></asp:TextBox>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="lastname">Have you tried any other businesses?</label>
                          <asp:TextBox ID="tbCustLname" runat="server" class="form-control"></asp:TextBox>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="message">Service Request</label>
                          <asp:TextBox ID="tbServiceRequest" runat="server" class="form-control" TextMode="MultiLine" ></asp:TextBox>
                      </div>
                    </div>
                        <div class="col-sm-6">
                      <div class="form-group">
                        <label for="email">Device Brand</label>
                            <asp:TextBox ID="tbDevBrand" runat="server" class="form-control"></asp:TextBox>
                      </div>
                    </div>
                          <div class="col-sm-6">
                      <div class="form-group">
                        <label for="lastname">Device Type</label>
                          <asp:TextBox ID="tbDevType" runat="server" class="form-control"></asp:TextBox>
                      </div>
                    </div>
                    <div class="col-sm-12 text-center">
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit Request" class="btn btn-template-outlined" />
