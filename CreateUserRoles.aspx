...
<script runat="server">
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs)
        Try
            ...
            Roles.CreateRole("Technican")

            Membership.CreateUser("Colin001", "password1")
            Membership.CreateUser("Mark002", "mccloskey1")

            Roles.AddUserToRole("Colin001", "Manager")
            Roles.AddUserToRole("Mark002", "Technican")

            lblresult.Text = "Roles, user accounts and users assigned to the roles have now been created"
          ...
          <div class="container"><a href="index.aspx" class="navbar-brand home"><img src="img/ibroke.jpg" alt="Logo" width="200" height="45" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Sell your Device<b class="caret"></b></a>
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Repairs<b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                ...
                <!-- ========== FULL WIDTH MEGAMENU ==================-->
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle">Shop<b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box">
                  ...
                  <asp:Button ID="btnRun" runat="server" OnClick="Button1_Click" Text="Run" Height="28px" />
