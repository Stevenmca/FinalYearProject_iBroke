<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShopCart.aspx.vb" Inherits="ShopCart" %>
            ...
            <div id="basket" class="col-lg-9">
              <div class="box mt-0 pb-0 no-horizontal-padding">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="auto-style1">
                              <asp:Button ID="Button1" runat="server" Text="Remove" ForeColor="#CC0000" />
                        ...
                        <tr>
                          ...
                          <td>
                              <asp:Label ID="lblProduct2" runat="server"></asp:Label>
                            </td>
                          <td>
                          ...
                          <td>
                              <asp:Button ID="Button2" runat="server" Text="Remove" ForeColor="#CC0000" />
                            </td>
                        </tr>
                             <tr>
                          
                          <td>
                              <asp:Label ID="lblProduct3" runat="server"></asp:Label>
                            </td>
                          <td>
                          ...
                          <td>
                              <asp:Label ID="lblQuantity3" runat="server"></asp:Label>
                            </td>
                          <td>
                              <asp:Label ID="lblTotal3" runat="server"></asp:Label>
                            </td>
                          <td>
                              <asp:Button ID="Button3" runat="server" Text="Remove" ForeColor="#CC0000" />
                              </td>
                        </tr>
                             <tr>
                          
                          <td>
                              <asp:Label ID="lblProduct4" runat="server"></asp:Label>
                            </td>
                          <td>
                          ...
                          <td>
                              <asp:Label ID="lblQuantity4" runat="server"></asp:Label>
                            </td>
                          <td>
                              <asp:Label ID="lblTotal4" runat="server"></asp:Label>
                            </td>
                          <td>
                              <asp:Button ID="Button4" runat="server" Text="Remove" ForeColor="#CC0000" />
                              </td>
                        </tr>
                      </tbody>
                      <tfoot>
                  ...
                  <div class="box-footer d-flex justify-content-between align-items-center">
                    <div class="left-col"><a href="ShopiPhone.aspx" class="btn btn-secondary mt-0"><i class="fa fa-chevron-left"></i> Continue shopping</a></div>
                    <div class="right-col">
                        <asp:Button ID="btnPayment" runat="server" class="btn btn-template-outlined" Text="Proceed to Delivery Details" />
                    </div>
                  </div>
              </div>
