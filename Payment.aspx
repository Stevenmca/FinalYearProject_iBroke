...
<title>iBroke</title>
              ...
              <div class="col-md-8 mx-auto">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <p class="text-muted lead text-center">For our payment we only accept PayPal payment. In order for your order to successfull follow these simple steps:

       </br>

       1.Follow the link provided to PayPal

       </br>

       2.Make out full payment to : <b>ibroke@hotmail.co.uk</b> 
       </br>
  ...
  <asp:HyperLink ID="HyperLink1" runat="server" Height="125px" ImageUrl="~/img/payp.png" NavigateUrl="https://www.paypal.com/uk/home" Width="131px"></asp:HyperLink>
                        </br>
              </br>
                        <p class="text-muted lead text-center">
                             NOTE: To check if payment has been successfull enter your Order Number into the Track your Order page. The options avaible are:
                            </br>
