            ...
            <div class="row">
              ...
              <div class="col-md-8 mx-auto">
                  ...
                  <div class="row">
                       <div class="col-sm-6">
                      <div class="form-group">
                        <label for="email">RequestID</label>
                            <asp:TextBox ID="tbRequestID" runat="server" class="form-control"></asp:TextBox>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <asp:Button ID="btnNewRequest" runat="server" Text="New Request" class="btn btn-template-outlined" />
